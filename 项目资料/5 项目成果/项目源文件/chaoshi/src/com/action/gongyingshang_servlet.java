...
{ 
	...
	public void gongyingshangAdd(HttpServletRequest req,HttpServletResponse res)
	{
		...
		Object[] params={mingcheng,dizhi,lianxiren,dianhua,youbian,chuanzhen,youxiang,"","","gongyingshang","no"};
		DB mydb=new DB();
	...
	public void gongyingshangMana(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
	{
		...
		String sql="select * from t_gongyingshang where type='gongyingshang' and del='no'";
		Object[] params={};
		DB mydb=new DB();
		try
		{
